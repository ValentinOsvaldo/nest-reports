...
export const getEmploymentLetterByIdReport = (
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      {
        text: `Yo, ${employerName}, en mi calidad de ${employerPosition} de ${employerCompany},por medio de la presente certifico que ${employeeName} ha sido empleado en nuestra empresa desde el ${employeeStartDate.toLocaleDateString()}.\n\n
